...
const figmaUrl =
  'https://www.figma.com/file/XnI28YVfYr7c83oZomUuC6qz/pbg-mobile?node-id=551%3A455';
const figmaUserCommentUrl =
  'https://www.figma.com/file/XnI28YVfYr7c83oZomUuC6qz/pbg-mobile?node-id=551%3A445';

storiesOf(
  'Consumer/Mobile/Atomic Components/ActivityCard/GroupActivityCard',
  module
)
...
storiesOf(
  'Consumer/Mobile/Atomic Components/ActivityCard/UserCommentCard',
  module
)
  .addDecorator(storyFn => (
    <WithFigma url={figmaUserCommentUrl}>{storyFn()}</WithFigma>
  ))
  .addDecorator(wrapStory)
  .addDecorator(withGreyContainer)
  .add('With userId', () => (
