...
storiesOf('Consumer/Desktop/Atomic Components/ActivityThumbnail', module)
  ...
  .add('Purchase Untipped', () => <ActivityThumbnail type="purchase_untipped" />)
  .add('Payment Authorized (Deposit)', () => <ActivityThumbnail type="payment_authorized_deposit" />)
  .add('Payment Authorized (Regular)', () => <ActivityThumbnail type="payment_authorized_regular" />)
  .add('Payment Authorized (Last)', () => <ActivityThumbnail type="payment_authorized_last" />)
  .add('Payment Captured', () => <ActivityThumbnail type="payment_captured" />)
  .add('Purchase Completed', () => <ActivityThumbnail type="purchase_completed" />)
