...
storiesOf('Consumer/Desktop/Atomic Components/Container', module)
  ...
  .add('container/solid shadow 1', () => <Container solid shadow1>{spacer}</Container>)
  .add('container/solid shadow 2', () => <Container solid shadow2>{spacer}</Container>)
  .add('container/stroked', () => <Container stroked>{spacer}</Container>)
  .add('container/stroked solid', () => <Container solid stroked>{spacer}</Container>)
  .add('container/stroked solid shadow 2', () => <Container solid stroked shadow1>{spacer}</Container>);