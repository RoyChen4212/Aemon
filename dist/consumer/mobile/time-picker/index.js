...
function (_DatePicker) {
  ...
  function TimePicker() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "baseClassName", 'pbg-form-field pbg-time-picker');
  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        ...
        className: "pbg-time-picker-container"
      }, _react.default.createElement("div", {
        className: "pbg-time-picker-mask"
...
var defaultFormater = function defaultFormater(time) {
