...
function (_React$PureComponent) {
  _inherits(ActivityComment, _React$PureComponent);

  function ActivityComment() {
    _classCallCheck(this, ActivityComment);

    return _possibleConstructorReturn(this, _getPrototypeOf(ActivityComment).apply(this, arguments));
  }
  ...
  _createClass(ActivityComment, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "activity-comment d-flex"
        ...
        className: "activity-comment-bubbletip"
      }), _react.default.createElement("p", {
        className: "activity-comment-title"
      }, this.props.title), _react.default.createElement("p", {
        className: "activity-comment-time"
      }, this.time), _react.default.createElement("p", {
        className: "activity-comment-comment"
      }, this.props.comment)));
    }
  }, {
    key: "time",
    get: function get() {
      return (0, _moment.default)(this.props.time).format("hh:mm A");
    }
  }]);
