...
* `shared`: contains all shared components between `desktop` and `mobile`. It also contains the CSS styleguide file (`scss/_styleguide.scss`).
...
* Have 100% coverage of your component code
* Include tests for the general behavior of the component
