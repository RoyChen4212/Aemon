...
describe('ActivityCard', () => {
  describe('rendering', () => {
    ...
    it('should render a description', () => {
      ...
      const wrapper = shallow(<ActivityCard type="purchase_updated" title={title} description={description} />);
      expect(wrapper.html()).to.include(description);
    });
    ...
    it('should render the time of the activity', () => {
      ...
      const wrapper = shallow(<ActivityCard type="purchase_updated" title={title} description={description} time={dateTime} />);
